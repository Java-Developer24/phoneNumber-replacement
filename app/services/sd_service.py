...
def call_sd_api(image_path: str, mask_path: str, new_number: str) -> str:
    ...
    formatted_prompt = f"Replace ONLY the phone number in the masked region with {new_number}. Keep font style, size, spacing, alignment, and background exactly the same. Do not modify anything else."
